...
void CanBusWorker::In(QVariant *enumVar, QVariant *dataVar)
{
    if (this->isRunning())
    {
        anAck("An External Signal Received !");
        ...
        else if (enumVarTypeName == QStringLiteral("CanBusWorkerDB::DataSet"))
        {
            ...
            {
                anInfo("case CanBusWorkerDB::replyPluginAndInterface");
            ...
            {
                anInfo("case CanBusWorkerDB::clearPendingFrameList");
                currentDB->pendingFrameList->clear();
                break;
            }
            case CanBusWorkerDB::addAFrameIntoPendingFrameList:
            {
                anInfo("case CanBusWorkerDB::addAFrameIntoPendingFrameList");
